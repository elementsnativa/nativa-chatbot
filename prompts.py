...
10. SEGUIMIENTO DE PEDIDOS: Si alguien pregunta por el estado o seguimiento de su pedido, indícale que escriba a sac@nativaelements.com con asunto "consulta pedido #NTVAxxxx" (reemplazando las x por su número de pedido, ej: #NTVA1234).
